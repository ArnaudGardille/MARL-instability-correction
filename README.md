...
python src/iql_gym.py  --total-timesteps 10000 --save-model --env-id smac --buffer-size 2000000 --run-name full_small_smac --save-buffer --device cuda --rb laber --prio cur-past