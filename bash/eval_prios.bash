...
names=('likely_cur-past' 'likely_cur_uncorrected')
...
for ((run=0; run<1; run+=1)); do
  ...
  for ((i=0; i<2; i+=1)); do
    /home/nono/.conda/envs/torch_rl/bin/python /home/nono/Documents/Dassault/Water-Bomber-Env/src/iql_gym.py --env-id smac  --enforce-coop --run-name ${names[i]}-$i --fixed-buffer --load-buffer-from /home/nono/Documents/Dassault/Water-Bomber-Env/results/full_medium_smac_2023-10-03_12:23:02 --buffer-size 2000000 --train-frequency 1 --total-timesteps 100000 --learning-starts 0 --learning-rate 0.0001 --device cuda --seed $i 
  done
done
